...
const createOverWeightValidationSchema = z.object({
  patientId: z.string({
...
const updateOverWeightValidationSchema = z.object({
...
export const OverWeightValidation = {
  createOverWeightValidationSchema,
  updateOverWeightValidationSchema,
};
