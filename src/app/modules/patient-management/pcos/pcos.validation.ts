...
const createPcosValidationSchema = z.object({
  patientId: z.string({
...
const updatePcosValidationSchema = z.object({
...
export const PcosValidation = {
  createPcosValidationSchema,
  updatePcosValidationSchema,
};
