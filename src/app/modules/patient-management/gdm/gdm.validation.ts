...
const createGdmValidationSchema = z.object({
  patientId: z.string({
...
const updateGdmValidationSchema = z.object({
...
export const GdmValidation = {
  createGdmValidationSchema,
  updateGdmValidationSchema,
};
